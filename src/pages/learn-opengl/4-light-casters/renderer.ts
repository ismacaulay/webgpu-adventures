...
//       update() {
//         // spot light
//         (cubeMaterialComponent.uniforms.light as UniformDictionary).position = camera.position;
//         (cubeMaterialComponent.uniforms.light as UniformDictionary).direction = camera.direction;
//       },
//     });
//   }
